...
def index():
    if request.method == 'POST':
        if 'my_image' in request.files and request.form['action'] == 'Submit':
            ...
            return render_template("index.html", prediction=predicted_tumor_type, img_path=img_path, uploaded_img=img.filename)
...
@app.route('/tumor_grade_detection', methods=['POST'])
def tumor_grade_detection():
    tumor_type = request.form['tumor_type']
